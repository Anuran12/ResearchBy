...
function About() {
  return (
    <div className="flex flex-col gap-6 items-center justify-start py-6 lg:py-10 px-4 lg:px-0">
      <h1 className="text-2xl lg:text-[3vw] font-bold text-center">About Us</h1>
      <p className="text-sm lg:text-[1.2vw] text-[#5F5F5F] text-center mt-2 lg:mt-0">
        Experience the future of research with our cutting-edge AI technology
        and professional network integration.
      </p>
      <div className="w-full flex flex-col gap- lg:flex-row lg:px-[6.5vw] pt-8 lg:pt-16">
        <div className="w-full lg:w-[50%] flex flex-col items-start justify-center gap-3 lg:gap-6 px-4 lg:px-0">
          <h1 className="text-2xl mb-4 lg:text-[3.8vw] font-semibold">
            About ResearchBy.ai
          </h1>
          <p className="text-sm lg:text-[1.2vw] text-[#A6A6A6]">
        ...
        <div className="w-full lg:w-[50%] lg:pl-16 flex flex-col items-start justify-center gap-5 mt-8 lg:mt-0 px-4 lg:px-0">
          <div className="flex gap-4 lg:gap-5">
            <div className="p-2 lg:p-3 shadow-md w-fit h-fit rounded-lg bg-white">
              <svg
                width="24"
                height="22"
                viewBox="0 0 28 26"
            ...
            <div className="flex flex-col gap-2">
              <h1 className="text-lg lg:text-[1.8vw] font-bold">
                Lightning Fast
              </h1>
              <p className="text-sm lg:text-[1.2vw] text-[#A6A6A6]">

    ...
    <div className="flex flex-col">
      ...
      <div className="py-16 px-4 lg:px-[15vw]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl lg:text-[2.5vw] font-bold mb-6">
              Our Mission
            </h2>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Pushing the boundaries of AI-powered research
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Making research tools available to everyone
                  </p>
                </div>
              </div>
            </div>
      ...
      <div className="py-16 px-4 lg:px-[15vw] bg-[#F9FAFB]">
        <h2 className="text-3xl lg:text-[2.5vw] font-bold text-center mb-12">
          Why Choose ResearchBy.ai?
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <div className="w-12 h-12 bg-[#FFF8D6] rounded-lg flex items-center justify-center mb-4">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
            ...
            <p className="text-gray-600">
              Advanced algorithms process vast amounts of academic content to
              deliver comprehensive research insights in minutes.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <p className="text-gray-600">
              Connect with experts and peers in your field to enhance your
              research with real-world insights and collaboration.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            ...
            <h3 className="text-xl font-semibold mb-3">Customizable Tools</h3>
            <p className="text-gray-600">
              Tailor your research experience with flexible settings and
              customizable parameters to match your specific needs.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="py-16 px-4 lg:px-[15vw]">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-bold text-[#F9DD4D] mb-2">
              500K+
            </div>
            <p className="text-gray-600">Research Papers Generated</p>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-bold text-[#F9DD4D] mb-2">
              98%
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600">Academic Partners</p>
          </div>
          <div className="text-center">
            <div className="text-4xl lg:text-5xl font-bold text-[#F9DD4D] mb-2">
              24/7
